...
var mydata = [{"name": '中国' , value: 84303},{"name": '美国' , value: 842629}]
...
var option = {
    ...
    visualMap: {
        ...
        splitList: [
            ...
            { start: 100000 }],
        color: ['#891830', '#CE445B', '#EB7778','#F6BABA','#FDE9E7','#FDFDF9']
    },
    //配置属性
    series: [
        {
...
myChart.on('click', function (params) {
    ...
    console.log(params.name);
        window.open('../../static/html/searchCountry.html?country='+params.name)
})